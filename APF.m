function [path_apf,path_apf_all,X_APF_final_id]=APF(vtheta_all,X_end_A_dubins,angle,X_now_APF,X_APF_final,step_param,obs_param,apf_param,A_dubins_param,path_apf_all,path_apf,X_APF_final_id,i)
