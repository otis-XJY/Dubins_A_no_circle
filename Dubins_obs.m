function [param_all,param_best] = Dubins_obs(Start_Point,End_Point,Avoid_Center,r_s,r_e,R,Stepsize,pos_id,parent_id)
...
param5.path = path5;
param5.pos_id = pos_id;
param5.parent_id = parent_id;
...
param6.path = path6;
param6.pos_id = pos_id;
param6.parent_id = parent_id;
end
...
param7.path = path7;
param7.pos_id = pos_id;
param7.parent_id = parent_id;
...
param8.path = path8;
param8.pos_id = pos_id;
param8.parent_id = parent_id;
end
