function  Draw_path(param,sure,from_path,to_path)
...
%     edge4x = param.center(1,2) + (param.R-sure)*cos(th);
%     edge4y = param.center(2,2) + (param.R-sure)*sin(th);
    edge3x = param.center(1,2) + param.r(2)*cos(th);
    edge3y = param.center(2,2) + param.r(2)*sin(th);
    plot(param.center(1,1),param.center(2,1),'o');
%     plot(param.center(1,2),param.center(2,2),'o');
    plot(param.center(1,2),param.center(2,2),'o');
...
xlabel(['Length:',num2str(param.Length)])
end
end