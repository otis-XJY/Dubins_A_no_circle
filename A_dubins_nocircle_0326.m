function [final_path,open,close]=A_dubins_nocircle_0326(Start_Point,End_Point,obs,sure,r,obs_no_circle,obs_no_circle_in,outline_all,Stepsize,total_field)
...
%                     min_indices(mm)
                ...
                display('sorry ,no path in begin')
                break;
            end
