function [Frep_x,Frep_y,angle,r_obs,angle1,angle2,Frep1,Frep2]=rep(pos,obs,k_rep,r_goal,safe_obs)
    ...
    Frep1=[Frep_x1,Frep_y1,sqrt(Frep_x1^2+Frep_y1^2)];
    Frep2=[Frep_x2,Frep_y2,sqrt(Frep_x2^2+Frep_y2^2)];
%     display([Frep1;Frep2])
