...
function path_RSR = PathfsRSR(paramN,Stepsize)
    ...
    Round1x = paramN.center(1,1) + paramN.r*cos(paramN.theta(1) - C1);
    Round1y = paramN.center(2,1) + paramN.r*sin(paramN.theta(1) - C1);
    Round2x = paramN.center(1,2) + paramN.r*cos(paramN.theta(3) - C2);
    Round2y = paramN.center(2,2) + paramN.r*sin(paramN.theta(3) - C2);
...
function path_RSR = PathRSR(param,Stepsize)
    ...
    Round1x = param.center(1,1) + param.r*cos(param.theta(1) - C1);
    Round1y = param.center(2,1) + param.r*sin(param.theta(1) - C1);
    Round2x = param.center(1,2) + param.R*cos(param.theta(3) - C2);
    Round2y = param.center(2,2) + param.R*sin(param.theta(3) - C2);
    Round3x = param.center(1,3) + param.r*cos(param.theta(5) - C3);
    Round3y = param.center(2,3) + param.r*sin(param.theta(5) - C3);
