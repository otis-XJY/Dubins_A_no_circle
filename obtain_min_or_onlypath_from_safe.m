...
%%type=1  =》选择最小，type=2=》only_safe_path     3=>最短
...
if type==3
    ...
    for i=1:length(length(param_all{1,1}))
    
        if param_all{1}(i).Length<min_path
            min_path=param_all{1}(i).Length;
            flag_min=i;
        end
